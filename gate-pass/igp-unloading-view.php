        ...
        <div class="box-body">
          <form id="igp-unloading-form" name="igp-unloading-form" action="#" method="post" onsubmit="return false;">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4">
                <input type="submit" name="submit" value="Print Gate Pass" class="btn btn-primary btn-block pull-left" onclick="">
              </div>
            </div>
          </form>
        </div>
  ...
  ?>
  <script type="text/javascript" src="<?php echo HOMEURL; ?>/gate-pass/js/gate-pass.js"></script>
