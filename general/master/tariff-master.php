          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="service_name">Unit</label>
                <input type="text" tabindex="1" class="form-control required" id="unit" name="unit" placeholder="Unit">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="service_name">Unit</label>
                <input type="text" tabindex="1" class="form-control required" id="edit_unit" name="edit_unit" placeholder="Unit">
