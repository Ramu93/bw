        ...
        <div class="box-body">
          <form action="#" onsubmit="return false;" name="add_party_form" class="form" id="add_party_form" method="POST">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-4">
              ...
              <input type="text" class="form-control required" id="pm_primaryContact" name="pm_primaryContact" placeholder="Primary Contact">
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sm-4">
              <label for="pm_primaryContactMobile">Primary Contact Mobile</label>
              <input type="text" class="form-control required" id="pm_primaryContactMobile" name="pm_primaryContactMobile" placeholder="Primary Contact Mobile">
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sm-4">
              <label for="pm_primaryContactEmail">Primary Contact Email</label>
              <input type="text" class="form-control required" id="pm_primaryContactEmail" name="pm_primaryContactEmail" placeholder="Primary Contact Email">
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sm-4">
