      ...
      <div class="box">
        <div class="box-body">
          ...
          <table id="ogp_table" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php 
                $select_query = "SELECT ou.ogp_un_id, ju.ju_id, ju.par_id, iu.vehicle_number, iu.driver_name, iu.driving_license, ou.created_date FROM general_ogp_unloading ou, general_joborder_unloading ju, general_igp_unloading iu WHERE ou.ju_id=ju.ju_id AND ju.par_id=iu.par_id AND ou.status='$status' AND ou.created_date BETWEEN '$filterFrom' AND '$filterTo'";
