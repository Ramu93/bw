<?php
	...
	function generateIGP(){
		...
		if(mysqli_query($dbc, $query)){
			switch ($dataType) {
				case 'pdr_id':
					$updatePdrStatusQuery = "UPDATE general_despatch_request SET status='". IGP_CREATED_STATUS ."' WHERE pdr_id='$dataValue'";
				break;
				case 'boe_number':
					$updatePdrStatusQuery = "UPDATE general_despatch_request SET status='". IGP_CREATED_STATUS ."' WHERE boe_number='$dataValue'";
				break;
				case 'bond_number':
					$updatePdrStatusQuery = "UPDATE general_despatch_request SET status='". IGP_CREATED_STATUS ."' WHERE bond_number='$dataValue'";
				break;
			}
