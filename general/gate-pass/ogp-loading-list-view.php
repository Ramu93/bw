      ...
      <div class="box">
        <div class="box-body">
          <table id="ogp_table" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php 
                $select_query = "SELECT ol.ogp_lo_id, ol.jl_id, jl.pdr_id, il.vehicle_number, il.driver_name, il.driving_license, ol.status FROM general_ogp_loading ol, general_joborder_loading jl, general_igp_loading il WHERE ol.jl_id=jl.jl_id AND jl.pdr_id=il.pdr_id";
