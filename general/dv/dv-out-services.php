<?php
	...
	function submitVerification(){
		...
		$query = "INSERT INTO general_dv_outward (pdr_id, exboe_original, order_number, vehicle_number, license_number) VALUES ('$pdrId', '$exboe', '$orderNumber', '$vehicleNumber', '$licenseNumber')";
