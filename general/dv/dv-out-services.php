<?php
	...
	function submitVerification(){
		...
		$query = "INSERT INTO general_dv_outward (pdr_id, exbond_original, exboe_original, order_number, vehicle_number, license_number) VALUES ('$pdrId', '$exbond', '$exboe', '$orderNumber', '$vehicleNumber', '$licenseNumber')";
	...
	function updateDocumentVerificationStatusInPDR(){
		global $dbc;
		$pdrId = $_POST['pdr_id'];
		$query = "UPDATE general_despatch_request SET document_verified='yes' WHERE pdr_id='$pdrId'";
