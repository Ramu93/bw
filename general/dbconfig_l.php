...
if(!defined('HOMEURL'))
	define('HOMEURL', 'http://localhost/samanapern/bonded_warehouse/general');

if(!defined('HOMEURLBONDED'))
	define('HOMEURLBONDED', 'http://localhost/samanapern/bonded_warehouse/bonded/');

if(!defined('LIBRARYURL'))
	define('LIBRARYURL', 'http://localhost/samanapern/bonded_warehouse/assets');
