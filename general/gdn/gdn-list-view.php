      ...
      <div class="box">
        <div class="box-body">
          ...
          <table id="gdn_table" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php 
                $select_query = "SELECT gdn.gdn_id, pdr.pdr_id, par.cha_name, pdr.transporter_name, par.importing_firm_name, gdn.created_date FROM general_good_delivery_note gdn, general_despatch_request pdr, pre_arrival_request par WHERE gdn.pdr_id=pdr.pdr_id AND pdr.par_id=par.par_id AND gdn.created_date BETWEEN '$filterFrom' AND '$filterTo'";
