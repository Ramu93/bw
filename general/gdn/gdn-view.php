<?php
  ...
  $out = array();
  $gdnId = $_GET['gdn_id'];
  $select = "SELECT gdn.gdn_id, pdr.pdr_id, par.cha_name, pdr.transporter_name, par.importing_firm_name, pdr.boe_number FROM general_good_delivery_note gdn, general_despatch_request pdr, pre_arrival_request par WHERE gdn.pdr_id=pdr.pdr_id AND pdr.par_id=par.par_id AND gdn.gdn_id='$gdnId'";
                ...
                <div class="col-md-10">
                  <table id="pdr_items_table"  class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                          $query = "SELECT * FROM general_pdr_items WHERE pdr_id='".$out['pdr_id']."'";
