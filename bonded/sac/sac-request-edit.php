...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Request for Issue of Space Availability Certificate - Edit
      </h1>
    </section>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" tabindex="3" class="form-control required" id="boe_date" name="boe_date" placeholder="BOL/AWB Date" value="<?php echo $row['boe_date']; ?>">
                </div>           
                <div class="form-group">
 ...
 <div class="modal fade" id="containerlist_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <script type="text/javascript">
    ...
    var isEditPage = true;// used to redirect to sac-request-view.php when update method is called
