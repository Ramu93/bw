      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo HOMEURL; ?>/sac/sac-request-approve-reject-view.php"><i class="fa fa-file"></i> View</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo HOMEURL; ?>/billing/generate-bill.php"><i class="fa fa-plus"></i> Generate Bill</a></li>
          </ul>
        </li>
      </ul>
    </section>
