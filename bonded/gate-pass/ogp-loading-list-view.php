      ...
      <div class="box">
        <div class="box-body">
          ...
          <table id="ogp_table" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php 
                $select_query = "SELECT ol.ogp_lo_id, ol.jl_id, jl.pdr_id, il.vehicle_number, il.driver_name, il.driving_license, ol.status, ol.created_date FROM bonded_ogp_loading ol, bonded_joborder_loading jl, bonded_igp_loading il WHERE ol.jl_id=jl.jl_id AND jl.pdr_id=il.pdr_id AND ol.created_date BETWEEN '$filterFrom' AND '$filterTo' AND ol.status='$status'";
