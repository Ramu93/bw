      ...
      <div class="box">
        <div class="box-body">
          <table id="gdn_table" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php 
                $select_query = "SELECT gdn.gdn_id, pdr.pdr_id, dv.bond_number, sac.cha_name, pdr.transporter_name, sac.importing_firm_name FROM bonded_good_delivery_note gdn, bonded_despatch_request pdr, sac_request sac, bonded_dv_inward dv WHERE gdn.pdr_id=pdr.pdr_id AND pdr.sac_id=sac.sac_id AND pdr.sac_id=dv.sac_id";
