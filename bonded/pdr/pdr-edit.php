          ...
          <form id="pdr_update_form" action="#" method="post" onsubmit="return false;">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control autofillparty required" id="cha_name_exporter" name="cha_name_exporter" value="<?php echo $out['cha_name']; ?>" placeholder="CHA Name/Exporter">
              </div>
              <div class="form-group col-md-4">
